...
R = 287 #J/kg(air)*K
R_mol = 8.314 # J/mol·K
v = 2 # m/s Feed velocity
pH = 101325 # Pa, Inital pressure (1 atm)
pL = 1000  # Pa, Vacuum pressure (10 mbar)
Twf = 373.15 # K, Desorption temperature
CO2_conc = 430 # ppm (Ambient)
...
# Switch to PEI sorbent 

# Packed Bed properites:
dp = 0.005 # m, pellet size
